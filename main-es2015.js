...
const IntegrationV2ExportDialogData = {
    guid: {
        "catalogItemKeyType": "guid",
        "catalogItemKey": "ED70588A-617E-4F24-9214-0EEC52949764",
...
let EndpointNavComponent = class EndpointNavComponent {
    constructor(environmentService, router) {
        ...
        this.dropdowns = [
            ...
            },
            {
                ...
                isCollapsed: true,
                btnClass: "bg-primary",
                items: Object.keys(src_app_services_environment_model__WEBPACK_IMPORTED_MODULE_11__["Environment"]).map(key => ({ key, title: src_app_services_environment_model__WEBPACK_IMPORTED_MODULE_11__["Environment"][key].title, onClick: (key) => this.onEnvironmentClick(key) }))
            },
        ];
        ...
        this.onEnvironmentClick = (key) => {
            if (!key)
                return;
            this.environmentService.set(src_app_services_environment_model__WEBPACK_IMPORTED_MODULE_11__["Environment"][key]);
        };
    }
    ngOnInit() {
...
EndpointNavComponent.ctorParameters = () => [
...
const isNullishOrEmptyString = (value) => {
...
const IntegrationV2CatalogData = {
    default: {
...
const IntegrationV2CatalogItemData = {
    guid: {
        "catalogItemKeyType": "guid",
        "catalogItemKey": "ED70588A-617E-4F24-9214-0EEC52949764",
